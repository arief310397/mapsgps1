...
public class MainLogin extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    private String url = "http://gpsumroh.com/maps/php/tampilusers.php";
    ...
    private void attemptLogin() {
        ...
        if (cancel) {
           ...
           // String type = params[0];
            String login_url = "http://gpsumroh.com/maps/php/listuser.php";
            try {
            ...
            {
                //get access of user
                login_url = "http://gpsumroh.com/maps/php/getaccess.php";
                try {
                    StrictMode.ThreadPolicy policy = new StrictMode.ThreadPolicy.Builder().permitAll().build();
                    StrictMode.setThreadPolicy(policy);
                    String user_name = email;
